...
def score(
    ...
    metric_utilities.verify_valid_probabilities(solution, 'solution')
    metric_utilities.verify_valid_probabilities(submission, 'submission')


    return metric_utilities.safe_call_score(kl_divergence, solution, submission, epsilon=epsilon, micro_average=micro_average, sample_weights=sample_weights)